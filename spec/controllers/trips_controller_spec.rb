  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved trip as @trip" do
        ...
        post :create, {:trip => { "user" => "invalid value" }}, valid_session
        assigns(:trip).should be_a_new(Trip)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested trip" do
        ...
        Trip.any_instance.should_receive(:update).with({ "user" => "" })
        put :update, {:id => trip.to_param, :trip => { "user" => "" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the trip as @trip" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Trip.any_instance.stub(:save).and_return(false)
        put :update, {:id => trip.to_param, :trip => { "user" => "invalid value" }}, valid_session
        assigns(:trip).should eq(trip)
      end
